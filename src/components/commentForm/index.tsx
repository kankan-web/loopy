    ...
    <div className="flex-1 flex flex-col bg-gray-50 focus-within:ring-2 focus-within:ring-blue-400 focus-within:border-none transition-all duration-300">
      ...
      >
        ...
        <div className="flex space-x-4 text-gray-500">
          ...
          {/* emoji-mart）实现表情选择器。 */}
          <Smile className="text-xl cursor-pointer hover:text-gray-700" size={20} />
          <Image className="text-xl cursor-pointer hover:text-gray-700" size={20} />
        </div>

        {/* 发送按钮 */}
        <div className="flex items-center gap-4 ">
          <span className="text-gray-500">
            <strong className="text-gray-800 font-normal">{count}</strong> / 1000
          </span>

          {/* 帮助 */}
          <TooltipProvider>
            <Tooltip title="标点符号、链接等不计算在有效数内">
